...
public class UploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prMasterView = findViewById(R.id.prMaster);
    ...
    public class ImportProducts extends AsyncTask<ArrayList<Product>,String, ArrayList<Product>>
    {
        ...
        Connection con = null;
        private final ProgressDialog dialog = new ProgressDialog(UploadActivity.this,R.style.CustomProgressStyle);
    ...
    public class ExportProducts extends AsyncTask<String,String, ArrayList<Product>>
    {
        ...
        protected void onPostExecute(ArrayList<Product> prlist) {
            if(!isSuccess){
                ...
                if(exportDataIntoWorkbook(getApplicationContext(),fileName,prlist)){
                    try{
                        File file = new File(getApplicationContext().getExternalFilesDir(DOWNLOAD_SERVICE), fileName);
                        Intent intent = new Intent(Intent.ACTION_VIEW);
                        Uri uri = FileProvider.getUriForFile(UploadActivity.this, "com.example.vgposrpt.provider",file);

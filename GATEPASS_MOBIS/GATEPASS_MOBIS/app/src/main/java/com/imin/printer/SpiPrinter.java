...
public class SpiPrinter {
    ...
    static SpiPrinter mSpiPrinter;
    FileOutputStream mFileOutputStream;
    FileInputStream mFileInputStream;

    private SerialPort mSerialPort;

    public static SpiPrinter getInstance() {
        synchronized (SpiPrinter.class) {
            if (mSpiPrinter == null)
                mSpiPrinter = new SpiPrinter();
        }
        return mSpiPrinter;
    }

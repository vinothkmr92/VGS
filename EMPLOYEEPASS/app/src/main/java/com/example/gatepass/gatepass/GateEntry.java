        ...
        protected void onPostExecute(String res){
            ...
            if(!res.isEmpty()){
                try{
                    ...
                    gatePassResponse.msgFromSAP = response[2].toString();
                    gatePassResponse.plant = response[3].toString();
                    String s = response[6].toString().toUpperCase();
                    if(s.equals("OK")) {
                    ...
                    if(response.length>7){
                        gatePassResponse.exception = response[7].toString();
                    ...
                    String vendorName = gatePassResponse.vendorName;
                    if(!vendorName.isEmpty()){
                       showCustomDialog("MSG","Sucessfully Registered Out Entry");
                       truckNumber.setText("");
                    }
                }
                catch (Exception ex){

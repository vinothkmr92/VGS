...
public class MySharedPreferences {
    ...
    private static com.example.mpos_orders.MySharedPreferences instance = null;
    ...
    public static com.example.mpos_orders.MySharedPreferences getInstance(Context contxt, String prefName) {
        if (instance == null) {
            instance = new com.example.mpos_orders.MySharedPreferences(contxt, prefName,
                    prefName+"Key", true);
        }
        return instance;
    }

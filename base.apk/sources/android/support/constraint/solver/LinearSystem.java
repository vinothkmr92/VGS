...
public class LinearSystem {
    ...
    private int enforceBFS(Row row) throws Exception {
        ...
        while (true) {
            ...
            while (obj == null) {
                ...
                while (i3 < linearSystem.mNumRows) {
                    ...
                    int i9;
                    float f5;
                    ArrayRow arrayRow = linearSystem.mRows[i3];
                    if (arrayRow.variable.mType == Type.UNRESTRICTED) {
                        if (arrayRow.isSimpleDefinition) {
                            if (arrayRow.constantValue < f) {
                                i7 = 1;
                                while (i7 < linearSystem.mNumColumns) {
                                    ...
                                    if (f3 <= f) {
                                        ...
                                        i4 = 0;
                                        while (i4 < 7) {
                                            f5 = solverVariable.strengthVector[i4] / f3;
                ...
                if (i2 > linearSystem.mNumColumns / 2) {
                    obj = 1;
                }
                f = 0.0f;
            }
        ...
        while (obj == null) {
            ...
            int i62 = 0;
            while (i32 < linearSystem.mNumRows) {
                ArrayRow arrayRow3 = linearSystem.mRows[i32];
                if (arrayRow3.variable.mType == Type.UNRESTRICTED) {
                    if (arrayRow3.isSimpleDefinition) {
                        if (arrayRow3.constantValue < f) {
                            ...
                            while (i7 < linearSystem.mNumColumns) {
                                solverVariable = linearSystem.mCache.mIndexedVariables[i7];
                                f3 = arrayRow3.variables.get(solverVariable);
                                if (f3 <= f) {
                                    i8 = i62;
                                    f4 = f22;
                                    i9 = i52;
                                    ...
                                    i42 = 0;
                                    while (i42 < 7) {
                                        f5 = solverVariable.strengthVector[i42] / f3;
                                        if (f5 >= f4) {
                                        }
                                        i42++;
                                    }
            ...
            if (i42 == -1) {
                ...
                ArrayRow arrayRow22 = linearSystem.mRows[i42];
                arrayRow22.variable.definitionId = -1;
                if (sMetrics != null) {
                    Metrics metrics22 = sMetrics;
                    metrics22.pivots++;
                }
                arrayRow22.pivot(linearSystem.mCache.mIndexedVariables[i52]);
                arrayRow22.variable.definitionId = i42;
                arrayRow22.variable.updateReferencesWithNewDefinition(arrayRow22);
            }
            if (i22 > linearSystem.mNumColumns / 2) {
                obj = 1;
            }
            f = 0.0f;
        }

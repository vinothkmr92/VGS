...
public class ViewBillsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try{
            ...
            ArrayAdapter<Counters> adapter = new ArrayAdapter<Counters>(this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,CommonUtil.countersList);

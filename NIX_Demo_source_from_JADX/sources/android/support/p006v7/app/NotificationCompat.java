...
import android.support.p003v4.app.NotificationCompat.MessagingStyle;
import android.support.p003v4.app.NotificationCompat.MessagingStyle.Message;
import android.support.p003v4.app.NotificationCompat.Style;
...
public class NotificationCompat extends android.support.p003v4.app.NotificationCompat {
    ...
    private static class Api24Extender extends BuilderExtender {
        ...
        public Notification build(android.support.p003v4.app.NotificationCompat.Builder b, NotificationBuilderWithBuilderAccessor builder) {
    ...
    public static class Builder extends android.support.p003v4.app.NotificationCompat.Builder {
    ...
    public static class MediaStyle extends Style {
        ...
        public MediaStyle(android.support.p003v4.app.NotificationCompat.Builder builder) {
            setBuilder(builder);
        }
    ...
    public static Token getMediaSession(Notification notification) {
        ...
        if (extras != null) {
            if (VERSION.SDK_INT >= 21) {
                Parcelable tokenInner = extras.getParcelable(android.support.p003v4.app.NotificationCompat.EXTRA_MEDIA_SESSION);
                if (tokenInner != null) {
                    return Token.fromToken(tokenInner);
                }
            } else {
                IBinder tokenInner2 = BundleCompat.getBinder(extras, android.support.p003v4.app.NotificationCompat.EXTRA_MEDIA_SESSION);
                if (tokenInner2 != null) {
    ...
    @TargetApi(24)
    @RequiresApi(24)
    public static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor builder, android.support.p003v4.app.NotificationCompat.Builder b) {
    ...
    @TargetApi(21)
    @RequiresApi(21)
    public static RemoteViews addStyleGetContentViewLollipop(NotificationBuilderWithBuilderAccessor builder, android.support.p003v4.app.NotificationCompat.Builder b) {
    ...
    @TargetApi(16)
    @RequiresApi(16)
    public static RemoteViews addStyleGetContentViewJellybean(NotificationBuilderWithBuilderAccessor builder, android.support.p003v4.app.NotificationCompat.Builder b) {
    ...
    /* access modifiers changed from: private */
    public static CharSequence makeMessageLine(android.support.p003v4.app.NotificationCompat.Builder b, MessagingStyle style, Message m) {
    ...
    private static void addMessagingFallBackStyle(MessagingStyle style, NotificationBuilderWithBuilderAccessor builder, android.support.p003v4.app.NotificationCompat.Builder b) {
        boolean showNames;
    ...
    @TargetApi(14)
    @RequiresApi(14)
    public static RemoteViews addStyleGetContentViewIcs(NotificationBuilderWithBuilderAccessor builder, android.support.p003v4.app.NotificationCompat.Builder b) {
        if (b.mStyle instanceof MediaStyle) {
            MediaStyle mediaStyle = (MediaStyle) b.mStyle;
    ...
    @TargetApi(16)
    @RequiresApi(16)
    public static void addBigStyleToBuilderJellybean(Notification n, android.support.p003v4.app.NotificationCompat.Builder b) {
    ...
    @TargetApi(21)
    @RequiresApi(21)
    private static void addDecoratedHeadsUpToBuilderLollipop(Notification n, android.support.p003v4.app.NotificationCompat.Builder b) {
    ...
    @TargetApi(21)
    @RequiresApi(21)
    public static void addBigStyleToBuilderLollipop(Notification n, android.support.p003v4.app.NotificationCompat.Builder b) {
        RemoteViews innerView;
        if (b.getBigContentView() != null) {
            innerView = b.getBigContentView();
        } else {
    ...
    private static void setBackgroundColor(Context context, RemoteViews views, int color) {
        if (color == 0) {
            color = context.getResources().getColor(C0289R.color.notification_material_background_media_default_color);
        }
        views.setInt(C0289R.C0291id.status_bar_latest_event_content, "setBackgroundColor", color);
    }

    /* access modifiers changed from: private */
    @TargetApi(21)
    @RequiresApi(21)
    public static void addHeadsUpToBuilderLollipop(Notification n, android.support.p003v4.app.NotificationCompat.Builder b) {
        RemoteViews innerView;

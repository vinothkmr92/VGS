...
import android.support.p006v7.app.ActionBar.LayoutParams;
import android.support.p006v7.app.ActionBar.OnMenuVisibilityListener;
import android.support.p006v7.app.ActionBar.OnNavigationListener;
import android.support.p006v7.app.ActionBar.Tab;
import android.support.p006v7.app.ActionBar.TabListener;
...
import android.support.p006v7.view.ActionMode.Callback;
...
import android.support.p006v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0289R.C0291id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0289R.C0291id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0289R.C0291id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0289R.C0291id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0289R.styleable.ActionBar, C0289R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0289R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0289R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0289R.attr.actionBarWidgetTheme, outValue, true);

...
import android.support.p003v4.widget.NestedScrollView.OnScrollChangeListener;
...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final android.support.p006v7.app.AlertController r11) {
            /*
                r10 = this;
                ...
                android.support.v7.app.AlertController$RecycleListView r6 = (android.support.p006v7.app.AlertController.RecycleListView) r6
            ...
            L_0x00a0:
                ...
                goto L_0x004f
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.app.AlertController.AlertParams.createListView(android.support.v7.app.AlertController):void");
        }
    }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0289R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0289R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0289R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0289R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0289R.styleable.AlertDialog, C0289R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0289R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0289R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0289R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0289R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0289R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0289R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0289R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0289R.C0291id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0289R.C0291id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0289R.C0291id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0289R.C0291id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0289R.C0291id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0289R.C0291id.topPanel);
        View customContentPanel = customPanel.findViewById(C0289R.C0291id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0289R.C0291id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0289R.C0291id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null && !hasCustomPanel) && !hasCustomPanel) {
                divider = topPanel.findViewById(C0289R.C0291id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0289R.C0291id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0289R.C0291id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0289R.C0291id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0289R.C0291id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0289R.C0291id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0289R.C0291id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0289R.C0291id.scrollView);

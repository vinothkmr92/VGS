...
import android.support.p006v7.view.menu.MenuPresenter.Callback;
...
public class Toolbar extends ViewGroup {
    ...
    private final android.support.p006v7.widget.ActionMenuView.OnMenuItemClickListener mMenuViewItemClickListener;
    ...
    public static class LayoutParams extends android.support.p006v7.app.ActionBar.LayoutParams {
        ...
        public LayoutParams(LayoutParams source) {
            super((android.support.p006v7.app.ActionBar.LayoutParams) source);
            this.mViewType = 0;
            this.mViewType = source.mViewType;
        }

        public LayoutParams(android.support.p006v7.app.ActionBar.LayoutParams source) {
            super(source);
            this.mViewType = 0;
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0289R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        C03761 r0 = new android.support.p006v7.widget.ActionMenuView.OnMenuItemClickListener() {
        ...
        C03772 r02 = new Runnable() {
            public void run() {
                Toolbar.this.showOverflowMenu();
            }
        };
        this.mShowOverflowMenuRunnable = r02;
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0289R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0289R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0289R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0289R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C0289R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_titleMargin, 0);
        if (a.hasValue(C0289R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int marginStart = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0289R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int contentInsetLeft = a.getDimensionPixelSize(C0289R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0289R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0289R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = a.getDrawable(C0289R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0289R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0289R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0289R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0289R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0289R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0289R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C0289R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C0289R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0289R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(a.getColor(C0289R.styleable.Toolbar_titleTextColor, -1));
        }
        if (a.hasValue(C0289R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0289R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0289R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0289R.attr.toolbarNavigationButtonStyle);
    ...
    public LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
        ...
        if (p instanceof android.support.p006v7.app.ActionBar.LayoutParams) {
            return new LayoutParams((android.support.p006v7.app.ActionBar.LayoutParams) p);
        }

...
import android.support.p003v4.view.ActionProvider.SubUiVisibilityListener;
import android.support.p003v4.view.GravityCompat;
import android.support.p006v7.appcompat.C0289R;
import android.support.p006v7.transition.ActionBarTransition;
import android.support.p006v7.view.ActionBarPolicy;
import android.support.p006v7.view.menu.ActionMenuItemView;
import android.support.p006v7.view.menu.ActionMenuItemView.PopupCallback;
...
import android.support.p006v7.widget.ActionMenuView.ActionMenuChildView;
...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu, View anchorView) {
            super(context, subMenu, anchorView, false, C0289R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0289R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0289R.attr.actionOverflowMenuStyle);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0289R.layout.abc_action_menu_layout, C0289R.layout.abc_action_menu_item_layout);
    }

...
import android.support.p003v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat;
import android.support.p003v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat;
...
import android.support.p003v4.widget.ScrollerCompat;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0292R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0292R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0292R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0292R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0292R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0292R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0292R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0292R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void createLayoutManager(android.content.Context r11, java.lang.String r12, android.util.AttributeSet r13, int r14, int r15) {
        ...
        L_0x001e:
            ...
            java.lang.Class<android.support.v7.widget.RecyclerView$LayoutManager> r8 = android.support.p006v7.widget.RecyclerView.LayoutManager.class
        ...
        L_0x0047:
            ...
            android.support.v7.widget.RecyclerView$LayoutManager r7 = (android.support.p006v7.widget.RecyclerView.LayoutManager) r7     // Catch:{ ClassNotFoundException -> 0x0088, InvocationTargetException -> 0x00aa, InstantiationException -> 0x00cc, IllegalAccessException -> 0x00ee, ClassCastException -> 0x0110 }
        ...
        L_0x0110:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p006v7.widget.RecyclerView.createLayoutManager(android.content.Context, java.lang.String, android.util.AttributeSet, int, int):void");
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r24) {
        ...
        L_0x0050:
            ...
            int r3 = android.support.p003v4.view.MotionEventCompat.getActionMasked(r24)
            int r4 = android.support.p003v4.view.MotionEventCompat.getActionIndex(r24)
        ...
        L_0x030e:
            ...
            int r0 = r0.mScrollPointerId
            r19 = r0
            float r18 = android.support.p003v4.view.VelocityTrackerCompat.getXVelocity(r18, r19)
            r0 = r18
            float r15 = -r0
        L_0x0345:
            ...
            int r0 = r0.mScrollPointerId
            r19 = r0
            float r18 = android.support.p003v4.view.VelocityTrackerCompat.getYVelocity(r18, r19)
            r0 = r18
            float r0 = -r0
            r17 = r0
        L_0x035c:

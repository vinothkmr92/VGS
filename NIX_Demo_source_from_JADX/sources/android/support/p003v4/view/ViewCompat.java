...
import android.support.p003v4.view.ViewCompatLollipop.OnApplyWindowInsetsListenerBridge;
...
public class ViewCompat {
    ...
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo39to = 1.0d) float value) {

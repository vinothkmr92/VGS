...
import android.support.p003v4.app.SupportActivity;
import android.support.p003v4.app.SupportActivity.ExtraData;
...
import android.support.p003v4.media.session.IMediaControllerCallback.Stub;
...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        private class StubApi21 implements android.support.p003v4.media.session.MediaControllerCompatApi21.Callback {
            StubApi21() {
            }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (volumeInfoObj != null) {
                return new PlaybackInfo(android.support.p003v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getPlaybackType(volumeInfoObj), android.support.p003v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getLegacyAudioStream(volumeInfoObj), android.support.p003v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getVolumeControl(volumeInfoObj), android.support.p003v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getMaxVolume(volumeInfoObj), android.support.p003v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getCurrentVolume(volumeInfoObj));
            }
            return null;
        }
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void play() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.play(this.mControlsObj);
        }

        public void pause() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.pause(this.mControlsObj);
        }

        public void stop() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.stop(this.mControlsObj);
        }

        public void seekTo(long pos) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, pos);
        }

        public void fastForward() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.fastForward(this.mControlsObj);
        }

        public void rewind() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.rewind(this.mControlsObj);
        }

        public void skipToNext() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.skipToNext(this.mControlsObj);
        }

        public void skipToPrevious() {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.skipToPrevious(this.mControlsObj);
        }

        public void setRating(RatingCompat rating) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.setRating(this.mControlsObj, rating != null ? rating.getRating() : null);
        }
        ...
        public void playFromMediaId(String mediaId, Bundle extras) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.playFromMediaId(this.mControlsObj, mediaId, extras);
        }

        public void playFromSearch(String query, Bundle extras) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.playFromSearch(this.mControlsObj, query, extras);
        }
        ...
        public void skipToQueueItem(long id) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, id);
        }

        public void sendCustomAction(CustomAction customAction, Bundle args) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.sendCustomAction(this.mControlsObj, customAction.getAction(), args);
        }

        public void sendCustomAction(String action, Bundle args) {
            android.support.p003v4.media.session.MediaControllerCompatApi21.TransportControls.sendCustomAction(this.mControlsObj, action, args);
        }
    }
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        public void playFromUri(Uri uri, Bundle extras) {
            android.support.p003v4.media.session.MediaControllerCompatApi23.TransportControls.playFromUri(this.mControlsObj, uri, extras);
        }
    }
    ...
    static class TransportControlsApi24 extends TransportControlsApi23 {
        ...
        public void prepare() {
            android.support.p003v4.media.session.MediaControllerCompatApi24.TransportControls.prepare(this.mControlsObj);
        }

        public void prepareFromMediaId(String mediaId, Bundle extras) {
            android.support.p003v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromMediaId(this.mControlsObj, mediaId, extras);
        }

        public void prepareFromSearch(String query, Bundle extras) {
            android.support.p003v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromSearch(this.mControlsObj, query, extras);
        }

        public void prepareFromUri(Uri uri, Bundle extras) {
            android.support.p003v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromUri(this.mControlsObj, uri, extras);
        }
    }

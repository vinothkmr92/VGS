...
import android.support.p003v4.util.Pools.Pool;
import android.support.p003v4.util.Pools.SimplePool;
import android.support.p003v4.util.Pools.SynchronizedPool;
...
import android.support.p003v4.view.ViewPager.DecorView;
import android.support.p003v4.view.ViewPager.OnAdapterChangeListener;
import android.support.p003v4.view.ViewPager.OnPageChangeListener;
...
public class TabLayout extends HorizontalScrollView {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            ...
            event.setClassName(android.support.p006v7.app.ActionBar.Tab.class.getName());
        }

        @TargetApi(14)
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            super.onInitializeAccessibilityNodeInfo(info);
            info.setClassName(android.support.p006v7.app.ActionBar.Tab.class.getName());
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0289R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0289R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0289R.styleable.TextAppearance_android_textColor);
            ta.recycle();

    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0289R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0013R.color.design_textinput_error_color_light));
                }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0289R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0013R.color.design_textinput_error_color_light));
                }

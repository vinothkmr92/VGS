...
class TransitionManagerStaticsIcs extends TransitionManagerStaticsImpl {
    ...
    /* renamed from: go */
    public void mo1244go(SceneImpl scene) {
        TransitionManagerPort.m60go(((SceneIcs) scene).mScene);
    }

    /* renamed from: go */
    public void mo1245go(SceneImpl scene, TransitionImpl transition) {
        TransitionManagerPort.m61go(((SceneIcs) scene).mScene, transition == null ? null : ((TransitionIcs) transition).mTransition);
    }

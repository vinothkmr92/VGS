...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String msg, int errorCorrectionLevel) throws WriterException {
        ...
        String fullCodewords = new StringBuilder(String.valueOf(dataCodewords)).append(PDF417ErrorCorrection.generateErrorCorrection(dataCodewords, errorCorrectionLevel)).toString();

...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f41FS = '\u001c';

    /* renamed from: GS */
    private static final char f42GS = '\u001d';
    ...
    /* renamed from: NS */
    private static final char f43NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f44RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, new StringBuilder(String.valueOf(postcode)).append(f42GS).append(country).append(f42GS).append(service).append(f42GS).toString());
                    break;
                } else {
                    result.insert(9, new StringBuilder(String.valueOf(postcode)).append(f42GS).append(country).append(f42GS).append(service).append(f42GS).toString());
                    break;
                }
            case 4:

...
/*
    	...
    	posPtr.printBitmap("//sdcard//temp//test//car_s.jpg", LKPrint.LK_ALIGNMENT_CENTER, 1);
    	posPtr.printBitmap("//sdcard//temp//test//car_s.jpg", LKPrint.LK_ALIGNMENT_CENTER, 2);
    	posPtr.printBitmap("//sdcard//temp//test//car_s.jpg", LKPrint.LK_ALIGNMENT_CENTER, 3);
*/
		posPtr.printAndroidFont("12-point 경찰청 한글 테스트 1234567890", 576, 12, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("14-point 경찰청 한글 테스트 1234567890", 576, 14, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("16-point 경찰청 한글 테스트 1234567890", 576, 16, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("18-point 경찰청 한글 테스트 1234567890", 576, 18, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("20-point 경찰청 한글 테스트 1234567890", 576, 20, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("22-point 경찰청 한글 테스트 1234567890", 576, 22, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("24-point 경찰청 한글 테스트 1234567890", 576, 24, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("26-point 경찰청 한글 테스트 1234567890", 576, 26, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("28-point 경찰청 한글 테스트 1234567890", 576, 28, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("30-point 경찰청 한글 테스트 1234567890", 576, 30, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont("32-point 경찰청 한글 테스트 1234567890", 576, 32, ESCPOSConst.LK_ALIGNMENT_LEFT);

		posPtr.printAndroidFont(typeface.MONOSPACE, "12-point 경찰청 한글 테스트 1234567890", 576, 12, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "14-point 경찰청 한글 테스트 1234567890", 576, 14, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "16-point 경찰청 한글 테스트 1234567890", 576, 16, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "18-point 경찰청 한글 테스트 1234567890", 576, 18, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "20-point 경찰청 한글 테스트 1234567890", 576, 20, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "22-point 경찰청 한글 테스트 1234567890", 576, 22, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "24-point 경찰청 한글 테스트 1234567890", 576, 24, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "26-point 경찰청 한글 테스트 1234567890", 576, 26, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "28-point 경찰청 한글 테스트 1234567890", 576, 28, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "30-point 경찰청 한글 테스트 1234567890", 576, 30, ESCPOSConst.LK_ALIGNMENT_LEFT);
		posPtr.printAndroidFont(typeface.MONOSPACE, "32-point 경찰청 한글 테스트 1234567890", 576, 32, ESCPOSConst.LK_ALIGNMENT_LEFT);

...
public class MSRTester extends TabActivity implements OnTabChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mTabHost.addTab(mTabHost.newTabSpec("msrMenu").setIndicator("Test").setContent(
				new Intent(this, MSRMenu.class)));

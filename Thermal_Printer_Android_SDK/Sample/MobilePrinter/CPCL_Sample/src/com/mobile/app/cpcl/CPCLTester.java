...
public class CPCLTester extends TabActivity implements OnTabChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mTabHost = getTabHost();			
		mTabHost.addTab(mTabHost.newTabSpec("sample2").setIndicator("2\" CPCL").setContent(
				new Intent(this, CPCL2Menu.class)));
		mTabHost.addTab(mTabHost.newTabSpec("sample3").setIndicator("3\" CPCL").setContent(
				new Intent(this, CPCL3Menu.class)));
		mTabHost.addTab(mTabHost.newTabSpec("sample4").setIndicator("4\" CPCL").setContent(
